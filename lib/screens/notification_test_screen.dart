...
class _NotificationTestScreenState extends State<NotificationTestScreen> {
  ...
  Future<void> _showDateTimePicker(BuildContext context) async {
    ...
    final initialDateTime = _selectedDateTime.isBefore(now) ? now : _selectedDateTime;
          ...
          children: [
            ...
            Expanded(
              child: CupertinoDatePicker(
                ...
                minimumDate: DateTime.now().subtract(const Duration(hours: 12)),
          ...
          child: Column(
            ...
            children: [
              ...
              if (_notiService.notifications.isEmpty)
                ...
                form.formGroup(
                  children: _notiService.notifications.map((noti) => Column(
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  noti.scheduledTime.toString().substring(0, 16),
                                  style: TextStyle(color: CupertinoColors.systemGrey),
                                ),
                              ],
                            ),
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: _getStatusColor(noti.status).withOpacity(0.2),
                                  borderRadius: BorderRadius.circular(12),
                                ),
                                child: Text(
                                  noti.status,
                                  style: TextStyle(color: _getStatusColor(noti.status)),
                                ),
                              ),
                              if (noti.status == 'pending')
                                CupertinoButton(
                                  ...
                                  onPressed: () {
                                    _notiService.cancelNotification(noti.id);
                                    setState(() {});
                                  },
                                ),
                            ],
