...
import 'package:flowo_client/blocs/create_task/create_task_cubit.dart';
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(labelText: 'Estimated Time (milliseconds)'),
                    keyboardType: TextInputType.number,
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                  ...
                  ListTile(
                    title: Text(_selectedDate == null
                        ...
                        : 'Deadline Date: ${_selectedDate!.toLocal()}'.split(' ')[0]),
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        ...
                        context.read<CreateTaskCubit>().createTask(
                          ...
                          _categoryController.text as Category, // TODO: Fix this
